...
(function() {
  ...
  function bindEvents() {
    ...
    if (elements.characterSelect) {
      elements.characterSelect.addEventListener('change', onCharacterChange);
    }
  ...
  function initCharacterSelection() {
    var selectedValue = elements.characterSelect ? elements.characterSelect.value : '';
    if (selectedValue) {
      loadCharacterConfig(selectedValue);
    } else {
  ...
  function onCharacterChange() {
    var characterId = elements.characterSelect.value;
  ...
  /**
   * Populate servo selection dropdown
   */
