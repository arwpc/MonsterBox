        ...
        const instructionsHtml = `
            <div class="ssl-instructions" style="background: #2a2a2a; border: 2px solid #ff6b6b; border-radius: 8px; padding: 20px; margin: 10px 0; color: #fff;">
                ...
                <ol style="margin: 15px 0; padding-left: 20px;">
                    <li>Click this link: <a href="https://${window.location.hostname}:8872" target="_blank" style="color: #4ecdc4; text-decoration: underline;">https://${window.location.hostname}:8872</a></li>
