# MonsterBox Goblin Container

A lightweight, containerized media player for distributed Halloween displays. Goblins are Raspberry Pi-based nodes that automatically discover and connect to MonsterBox instances for coordinated video and audio playback.
...
1. **Clone and navigate to container directory:**
   ```bash
   cd MonsterBox/goblin-container
   ```
...
docker logs monsterbox-goblin

# Restart container
docker restart monsterbox-goblin
```
