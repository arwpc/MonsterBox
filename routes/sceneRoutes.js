...
router.get('/', (req, res, next) => {
    sceneController.getAllScenes(req, res, next, req.session.characterId);
});

router.get('/new', (req, res, next) => {
    sceneController.newScene(req, res, next, req.session.characterId);
});

router.get('/step-template', (req, res, next) => {
    sceneController.getStepTemplate(req, res, next, req.session.characterId);
});

router.get('/:id', (req, res, next) => {
    scenePlayerController.getScenePlayer(req, res, next, req.session.characterId);
});

router.get('/:id/edit', (req, res, next) => {
    sceneController.getSceneById(req, res, next, req.session.characterId);
});

router.post('/', (req, res, next) => {
    req.body.characterId = req.session.characterId;
...
router.get('/:id/play', (req, res, next) => {
    scenePlayerController.playScene(req, res, next, req.session.characterId);
});
