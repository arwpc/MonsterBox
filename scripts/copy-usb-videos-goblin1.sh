#!/bin/bash
#
# Copy and convert USB videos for Goblin1
# Runs independently - finds USB drives, converts videos, deploys to Goblin1
#

GOBLIN_IP="192.168.8.40"
SSH_PASS="klrklr89!"
SSH_USER="remote"

LOG_FILE="/home/remote/MonsterBox/logs/usb-goblin1-$(date +%Y%m%d-%H%M%S).log"
...
log "🎃 Starting USB video copy for Goblin1 ($GOBLIN_IP)"
...
log "   Deployed to Goblin1: $deployed_videos"
