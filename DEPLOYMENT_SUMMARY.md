...
./scripts/deploy-to-animatronic.sh 192.168.8.150  # PumpkinHead
./scripts/deploy-to-animatronic.sh 192.168.8.140  # Coffin Breaker
./scripts/deploy-to-animatronic.sh 192.168.8.130  # Skulltalker
```
