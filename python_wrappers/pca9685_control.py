...
def pca9685_init(i2c_address=PCA9685_DEFAULT_ADDRESS):
    ...
    try:
        # Try to import smbus2 first (preferred), then fall back to smbus
        try:
        ...
        log_message({
            "status": "error",
            "message": "SMBus library not available. Install with: sudo apt install python3-smbus python3-smbus2 or pip3 install smbus2"
        })
        raise
