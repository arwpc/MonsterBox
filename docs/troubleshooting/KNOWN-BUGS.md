...
- 🔴 **STILL OPEN — PIR part 5.** Re-probed 2026-09-07: with pull-down it sits LOW; with pull-up it
  flickers hi/lo (something weak on the line, unlike the 08-31 probe that followed the pull exactly);
  a 20 s live watch at 20 Hz saw **zero** highs. The `physical-faults.json` entry stays until a wave
  test in front of the sensor shows GPIO16 going HIGH.
