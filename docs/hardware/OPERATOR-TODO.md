...
## C. Confirm the knight's head servo — is the channel dead, or was the probe invalid?

**Status: genuinely unresolved, and the two measurements disagree.**
...
## D. Was the knight's head over-rotated on 2026-08-21? — **please eyeball the cabling**

One probe commanded `move_to_pca 60→90` = 277 µs. On a 900° servo that is **~125° of rotation**,
beyond the ±45° that was cleared. If the channel is in fact dead (see C) nothing moved and there is
nothing to check. Worth a look at the head and its cable loom either way.
